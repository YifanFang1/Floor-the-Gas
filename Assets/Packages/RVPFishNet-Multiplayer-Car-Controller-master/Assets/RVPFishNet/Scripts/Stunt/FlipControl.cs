...
namespace RVP
{
    ...
    public class FlipControl : MonoBehaviour, IVehicleComponent
    {
        ...
        void IVehicleComponent.Simulate()
        {
            ...
            {
                _velDir = Quaternion.LookRotation(GlobalControl.worldUpDir, _rb.linearVelocity);
        ...
        private void ApplyRotationCorrection()
        {
            ...
            if (groundCheckDistance > 0)
            {
                ...
                if (Physics.Raycast(transform.position, (-GlobalControl.worldUpDir + _rb.linearVelocity).normalized, out groundHit, groundCheckDistance, GlobalControl.groundMaskStatic))
                {
