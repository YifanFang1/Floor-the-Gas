...
namespace RVP
{
    ...
    public class VehicleParent : MonoBehaviour, IVehicleComponent
    {
        ...
        void IVehicleComponent.GetFullState(Writer writer)
        {
            ...
            writer.WriteVector3(_rb.linearVelocity);
        ...
        void IVehicleComponent.SetFullState(Reader reader)
        {
            ...
            _rb.linearVelocity = reader.ReadVector3();
        ...
        void IVehicleComponent.Simulate()
        {
            ...
            StaticStateLogger.Log($"VehicleParent:_rb.velocity={_rb.linearVelocity}");
            ...
            localVelocity = transform.InverseTransformDirection(_rb.linearVelocity - _wheelContactsVelocity);
            localAngularVel = transform.InverseTransformDirection(_rb.angularVelocity);
            velMag = _rb.linearVelocity.magnitude;
            sqrVelMag = _rb.linearVelocity.sqrMagnitude;
